# UX-NAV-01-008-commercial-ia-map-frontend - Commercial information architecture map - Frontend experience

        Task UX-NAV-01-008-commercial-ia-map-frontend: Commercial information architecture map - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Commercial information architecture map.
...
Dependencies:
- UX-NAV-01-007-commercial-ia-map-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Commercial information architecture map.
