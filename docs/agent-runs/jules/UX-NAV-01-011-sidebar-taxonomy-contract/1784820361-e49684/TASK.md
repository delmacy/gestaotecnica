# UX-NAV-01-011-sidebar-taxonomy-contract - Sidebar taxonomy and grouping - Contract

        Task UX-NAV-01-011-sidebar-taxonomy-contract: Sidebar taxonomy and grouping - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Sidebar taxonomy and grouping.
...
Dependencies:
- UX-NAV-01-010-commercial-ia-map-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Sidebar taxonomy and grouping.
