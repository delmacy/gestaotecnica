# UX-NAV-01-018-global-capabilities-entry-frontend - Global capabilities entry experience - Frontend experience

        Task UX-NAV-01-018-global-capabilities-entry-frontend: Global capabilities entry experience - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Global capabilities entry experience.
...
Dependencies:
- UX-NAV-01-017-global-capabilities-entry-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Global capabilities entry experience.
