# UX-NAV-01-021-platform-vs-workspace-scope-contract - Platform versus workspace scope clarity - Contract

        Task UX-NAV-01-021-platform-vs-workspace-scope-contract: Platform versus workspace scope clarity - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Platform versus workspace scope clarity.
...
Dependencies:
- UX-NAV-01-020-global-capabilities-entry-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Platform versus workspace scope clarity.
