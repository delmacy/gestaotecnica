# UX-NAV-01-031-primary-action-model-contract - Primary action and next-step model - Contract

        Task UX-NAV-01-031-primary-action-model-contract: Primary action and next-step model - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Primary action and next-step model.
...
Dependencies:
- UX-NAV-01-030-breadcrumb-foundation-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Primary action and next-step model.
