# UX-NAV-01-032-primary-action-model-backend - Primary action and next-step model - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: Primary action and next-step model.
...
Dependencies:
- UX-NAV-01-031-primary-action-model-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for Primary action and next-step model.
