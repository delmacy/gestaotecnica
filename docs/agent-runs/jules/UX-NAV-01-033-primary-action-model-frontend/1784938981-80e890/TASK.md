# UX-NAV-01-033-primary-action-model-frontend - Primary action and next-step model - Frontend experience

        Task UX-NAV-01-033-primary-action-model-frontend: Primary action and next-step model - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Primary action and next-step model.
...
Dependencies:
- UX-NAV-01-032-primary-action-model-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Primary action and next-step model.
