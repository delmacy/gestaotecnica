# UX-NAV-01-034-primary-action-model-e2e - Primary action and next-step model - Journey validation

        Task UX-NAV-01-034-primary-action-model-e2e: Primary action and next-step model - Journey validation
...
Objective:
Validate the journey end-to-end with focused route, component, or browser evidence and no fake assertions. Focus area: Primary action and next-step model.
...
Dependencies:
- UX-NAV-01-033-primary-action-model-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for Primary action and next-step model.
