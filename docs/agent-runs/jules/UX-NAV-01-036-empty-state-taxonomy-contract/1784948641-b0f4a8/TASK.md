# UX-NAV-01-036-empty-state-taxonomy-contract - Empty and unavailable state taxonomy - Contract

        Task UX-NAV-01-036-empty-state-taxonomy-contract: Empty and unavailable state taxonomy - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Empty and unavailable state taxonomy.
...
Dependencies:
- UX-NAV-01-035-primary-action-model-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Empty and unavailable state taxonomy.
