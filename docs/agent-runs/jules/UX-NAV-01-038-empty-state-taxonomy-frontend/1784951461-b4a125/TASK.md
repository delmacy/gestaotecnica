# UX-NAV-01-038-empty-state-taxonomy-frontend - Empty and unavailable state taxonomy - Frontend experience

        Task UX-NAV-01-038-empty-state-taxonomy-frontend: Empty and unavailable state taxonomy - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Empty and unavailable state taxonomy.
...
Dependencies:
- UX-NAV-01-037-empty-state-taxonomy-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Empty and unavailable state taxonomy.
