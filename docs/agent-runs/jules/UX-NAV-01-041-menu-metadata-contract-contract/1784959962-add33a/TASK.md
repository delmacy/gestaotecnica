# UX-NAV-01-041-menu-metadata-contract-contract - Typed menu metadata contract - Contract

        Task UX-NAV-01-041-menu-metadata-contract-contract: Typed menu metadata contract - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Typed menu metadata contract.
...
Dependencies:
- UX-NAV-01-040-empty-state-taxonomy-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Typed menu metadata contract.
