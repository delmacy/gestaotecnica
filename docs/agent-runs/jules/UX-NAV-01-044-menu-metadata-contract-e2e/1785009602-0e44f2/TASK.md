# UX-NAV-01-044-menu-metadata-contract-e2e - Typed menu metadata contract - Journey validation

        Task UX-NAV-01-044-menu-metadata-contract-e2e: Typed menu metadata contract - Journey validation
...
Dependencies:
- UX-NAV-01-043-menu-metadata-contract-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for Typed menu metadata contract.
