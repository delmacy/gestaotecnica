# UX-NAV-02-001-origin-context-contract - Origin and active context model - Contract

        Task UX-NAV-02-001-origin-context-contract: Origin and active context model - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Origin and active context model.
...
- Pipeline discipline is respected: this task completes only the contract stage for Origin and active context model.
