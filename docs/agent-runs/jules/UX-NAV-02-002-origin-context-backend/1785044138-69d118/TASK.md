# UX-NAV-02-002-origin-context-backend - Origin and active context model - Backend/data binding

        Task UX-NAV-02-002-origin-context-backend: Origin and active context model - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: Origin and active context model.
...
Dependencies:
- UX-NAV-02-001-origin-context-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for Origin and active context model.
