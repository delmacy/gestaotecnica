# UX-NAV-02-003-origin-context-frontend - Origin and active context model - Frontend experience

        Task UX-NAV-02-003-origin-context-frontend: Origin and active context model - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Origin and active context model.
...
Dependencies:
- UX-NAV-02-002-origin-context-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Origin and active context model.
