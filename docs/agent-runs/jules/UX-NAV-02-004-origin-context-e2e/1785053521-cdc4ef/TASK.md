# UX-NAV-02-004-origin-context-e2e - Origin and active context model - Journey validation

        Task UX-NAV-02-004-origin-context-e2e: Origin and active context model - Journey validation
...
Objective:
Validate the journey end-to-end with focused route, component, or browser evidence and no fake assertions. Focus area: Origin and active context model.
...
Dependencies:
- UX-NAV-02-003-origin-context-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for Origin and active context model.
