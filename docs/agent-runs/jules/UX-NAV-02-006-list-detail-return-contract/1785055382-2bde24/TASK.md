# UX-NAV-02-006-list-detail-return-contract - List/detail/create/edit return paths - Contract

        Task UX-NAV-02-006-list-detail-return-contract: List/detail/create/edit return paths - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: List/detail/create/edit return paths.
...
Dependencies:
- UX-NAV-02-005-origin-context-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for List/detail/create/edit return paths.
