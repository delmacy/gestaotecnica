# UX-NAV-02-007-list-detail-return-backend - List/detail/create/edit return paths - Backend/data binding

        Task UX-NAV-02-007-list-detail-return-backend: List/detail/create/edit return paths - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: List/detail/create/edit return paths.
...
Dependencies:
- UX-NAV-02-006-list-detail-return-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for List/detail/create/edit return paths.
