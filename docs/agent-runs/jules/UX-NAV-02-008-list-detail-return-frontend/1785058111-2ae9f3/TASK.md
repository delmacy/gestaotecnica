# UX-NAV-02-008-list-detail-return-frontend - List/detail/create/edit return paths - Frontend experience

        Task UX-NAV-02-008-list-detail-return-frontend: List/detail/create/edit return paths - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: List/detail/create/edit return paths.
...
Dependencies:
- UX-NAV-02-007-list-detail-return-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for List/detail/create/edit return paths.
