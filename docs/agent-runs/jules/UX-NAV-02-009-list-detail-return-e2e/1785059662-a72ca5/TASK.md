# UX-NAV-02-009-list-detail-return-e2e - List/detail/create/edit return paths - Journey validation

        Task UX-NAV-02-009-list-detail-return-e2e: List/detail/create/edit return paths - Journey validation
...
Objective:
Validate the journey end-to-end with focused route, component, or browser evidence and no fake assertions. Focus area: List/detail/create/edit return paths.
...
Dependencies:
- UX-NAV-02-008-list-detail-return-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for List/detail/create/edit return paths.
