# UX-NAV-02-016-cancel-back-model-contract - Cancel/back/discard behavior - Contract

        Task UX-NAV-02-016-cancel-back-model-contract: Cancel/back/discard behavior - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Cancel/back/discard behavior.
...
Dependencies:
- UX-NAV-02-015-success-next-step-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Cancel/back/discard behavior.
