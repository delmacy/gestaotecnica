# UX-NAV-02-017-cancel-back-model-backend - Cancel/back/discard behavior - Backend/data binding

        Task UX-NAV-02-017-cancel-back-model-backend: Cancel/back/discard behavior - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: Cancel/back/discard behavior.
...
Dependencies:
- UX-NAV-02-016-cancel-back-model-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for Cancel/back/discard behavior.
