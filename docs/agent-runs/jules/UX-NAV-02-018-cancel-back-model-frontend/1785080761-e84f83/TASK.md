# UX-NAV-02-018-cancel-back-model-frontend - Cancel/back/discard behavior - Frontend experience

        Task UX-NAV-02-018-cancel-back-model-frontend: Cancel/back/discard behavior - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Cancel/back/discard behavior.
...
Dependencies:
- UX-NAV-02-017-cancel-back-model-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Cancel/back/discard behavior.
