# UX-NAV-02-019-cancel-back-model-e2e - Cancel/back/discard behavior - Journey validation

        Task UX-NAV-02-019-cancel-back-model-e2e: Cancel/back/discard behavior - Journey validation
...
Objective:
Validate the journey end-to-end with focused route, component, or browser evidence and no fake assertions. Focus area: Cancel/back/discard behavior.
...
Dependencies:
- UX-NAV-02-018-cancel-back-model-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for Cancel/back/discard behavior.
