# UX-NAV-02-021-workspace-switching-contract - Workspace and client context switching - Contract

        Task UX-NAV-02-021-workspace-switching-contract: Workspace and client context switching - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Workspace and client context switching.
...
Dependencies:
- UX-NAV-02-020-cancel-back-model-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Workspace and client context switching.
