# UX-NAV-02-022-workspace-switching-backend - Workspace and client context switching - Backend/data binding

        Task UX-NAV-02-022-workspace-switching-backend: Workspace and client context switching - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: Workspace and client context switching.
...
Dependencies:
- UX-NAV-02-021-workspace-switching-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for Workspace and client context switching.
