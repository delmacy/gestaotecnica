# UX-NAV-02-023-workspace-switching-frontend - Workspace and client context switching - Frontend experience

        Task UX-NAV-02-023-workspace-switching-frontend: Workspace and client context switching - Frontend experience
...
Dependencies:
- UX-NAV-02-022-workspace-switching-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Workspace and client context switching.
