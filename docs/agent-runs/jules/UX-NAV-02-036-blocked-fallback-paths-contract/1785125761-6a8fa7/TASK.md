# UX-NAV-02-036-blocked-fallback-paths-contract - Blocked/error/fallback paths - Contract

        Task UX-NAV-02-036-blocked-fallback-paths-contract: Blocked/error/fallback paths - Contract
...
Objective:
Define the route contract, data contract, role/scope rules, states, and acceptance gates before implementation. Focus area: Blocked/error/fallback paths.
...
Dependencies:
- UX-NAV-02-035-runtime-evidence-handoff-closeout
...
- Pipeline discipline is respected: this task completes only the contract stage for Blocked/error/fallback paths.
