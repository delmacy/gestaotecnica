# UX-NAV-02-037-blocked-fallback-paths-backend - Blocked/error/fallback paths - Backend/data binding

        Task UX-NAV-02-037-blocked-fallback-paths-backend: Blocked/error/fallback paths - Backend/data binding
...
Objective:
Implement or expose the minimal real data/API/server-action support required by the agreed contract, without UI scope creep. Focus area: Blocked/error/fallback paths.
...
Dependencies:
- UX-NAV-02-036-blocked-fallback-paths-contract
...
- Pipeline discipline is respected: this task completes only the backend/data binding stage for Blocked/error/fallback paths.
