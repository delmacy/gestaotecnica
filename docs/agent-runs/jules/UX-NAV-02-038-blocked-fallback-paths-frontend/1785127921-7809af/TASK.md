# UX-NAV-02-038-blocked-fallback-paths-frontend - Blocked/error/fallback paths - Frontend experience

        Task UX-NAV-02-038-blocked-fallback-paths-frontend: Blocked/error/fallback paths - Frontend experience
...
Objective:
Implement the user-facing route/menu/flow experience against the agreed contract, without inventing new backend behavior. Focus area: Blocked/error/fallback paths.
...
Dependencies:
- UX-NAV-02-037-blocked-fallback-paths-backend
...
- Pipeline discipline is respected: this task completes only the frontend experience stage for Blocked/error/fallback paths.
