# UX-NAV-02-039-blocked-fallback-paths-e2e - Blocked/error/fallback paths - Journey validation

        Task UX-NAV-02-039-blocked-fallback-paths-e2e: Blocked/error/fallback paths - Journey validation
...
Objective:
Validate the journey end-to-end with focused route, component, or browser evidence and no fake assertions. Focus area: Blocked/error/fallback paths.
...
Dependencies:
- UX-NAV-02-038-blocked-fallback-paths-frontend
...
- Pipeline discipline is respected: this task completes only the journey validation stage for Blocked/error/fallback paths.
