# UX-NAV-03-002-operator-work-intake-core-domain - Operator work intake creates persisted work - Core domain model

        Implement the core domain model stage for `Operator work intake creates persisted work` in UX-NAV-03.
