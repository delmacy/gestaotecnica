# UX-NAV-03-003-operator-work-intake-contracts - Operator work intake creates persisted work - Contracts and DTOs

        Implement the contracts and dtos stage for `Operator work intake creates persisted work` in UX-NAV-03.
