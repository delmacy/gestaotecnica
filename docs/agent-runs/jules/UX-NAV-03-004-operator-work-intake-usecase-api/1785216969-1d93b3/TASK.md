# UX-NAV-03-004-operator-work-intake-usecase-api - Operator work intake creates persisted work - Use case and API binding

        Implement the use case and api binding stage for `Operator work intake creates persisted work` in UX-NAV-03.
