# UX-NAV-03-005-operator-work-intake-ui-navigation - Operator work intake creates persisted work - UI navigation surface

        Implement the ui navigation surface stage for `Operator work intake creates persisted work` in UX-NAV-03.
