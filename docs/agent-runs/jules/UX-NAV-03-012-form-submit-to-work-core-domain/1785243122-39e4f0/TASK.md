# UX-NAV-03-012-form-submit-to-work-core-domain - Form submit creates and returns work status - Core domain model

        Implement the core domain model stage for `Form submit creates and returns work status` in UX-NAV-03.
