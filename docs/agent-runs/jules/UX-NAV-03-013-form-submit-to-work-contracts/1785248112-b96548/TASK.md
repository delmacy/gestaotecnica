# UX-NAV-03-013-form-submit-to-work-contracts - Form submit creates and returns work status - Contracts and DTOs

        Implement the contracts and dtos stage for `Form submit creates and returns work status` in UX-NAV-03.
