# UX-NAV-03-014-form-submit-to-work-usecase-api - Form submit creates and returns work status - Use case and API binding

        Implement the use case and api binding stage for `Form submit creates and returns work status` in UX-NAV-03.
