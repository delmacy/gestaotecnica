# UX-NAV-03-015-form-submit-to-work-ui-navigation - Form submit creates and returns work status - UI navigation surface

        Implement the ui navigation surface stage for `Form submit creates and returns work status` in UX-NAV-03.
