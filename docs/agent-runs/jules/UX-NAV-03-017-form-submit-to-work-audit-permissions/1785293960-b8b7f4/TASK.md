# UX-NAV-03-017-form-submit-to-work-audit-permissions - Form submit creates and returns work status - Permissions, audit, and receipts

        Implement the permissions, audit, and receipts stage for `Form submit creates and returns work status` in UX-NAV-03.
