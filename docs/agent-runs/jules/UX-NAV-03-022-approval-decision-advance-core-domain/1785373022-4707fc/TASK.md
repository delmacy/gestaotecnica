# UX-NAV-03-022-approval-decision-advance-core-domain - Approval decision advances real workflow - Core domain model

        Implement the core domain model stage for `Approval decision advances real workflow` in UX-NAV-03.
