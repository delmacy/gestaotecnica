# UX-NAV-03-025-approval-decision-advance-ui-navigation - Approval decision advances real workflow - UI navigation surface

        Implement the ui navigation surface stage for `Approval decision advances real workflow` in UX-NAV-03.
