# UX-NAV-03-031-attachment-timeline-proof-database - Attachments and timeline show proof of work - Database/persistence foundation

        Implement the database/persistence foundation stage for `Attachments and timeline show proof of work` in UX-NAV-03.
