# UX-NAV-03-032-attachment-timeline-proof-core-domain - Attachments and timeline show proof of work - Core domain model

        Implement the core domain model stage for `Attachments and timeline show proof of work` in UX-NAV-03.
