# UX-NAV-03-033-attachment-timeline-proof-contracts - Attachments and timeline show proof of work - Contracts and DTOs

        Implement the contracts and dtos stage for `Attachments and timeline show proof of work` in UX-NAV-03.
