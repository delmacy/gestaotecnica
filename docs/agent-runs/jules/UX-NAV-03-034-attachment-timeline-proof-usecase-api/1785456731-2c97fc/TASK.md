# UX-NAV-03-034-attachment-timeline-proof-usecase-api - Attachments and timeline show proof of work - Use case and API binding

        Implement the use case and api binding stage for `Attachments and timeline show proof of work` in UX-NAV-03.
