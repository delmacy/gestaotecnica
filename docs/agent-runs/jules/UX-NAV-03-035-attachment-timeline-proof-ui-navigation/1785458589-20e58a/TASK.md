# UX-NAV-03-035-attachment-timeline-proof-ui-navigation - Attachments and timeline show proof of work - UI navigation surface

        Implement the ui navigation surface stage for `Attachments and timeline show proof of work` in UX-NAV-03.
