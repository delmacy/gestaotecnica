# UX-NAV-03-036-attachment-timeline-proof-ui-actions - Attachments and timeline show proof of work - Buttons, forms, and state feedback

        Implement the buttons, forms, and state feedback stage for `Attachments and timeline show proof of work` in UX-NAV-03.
