# UX-NAV-03-038-attachment-timeline-proof-integration-binding - Attachments and timeline show proof of work - End-to-end binding

        Implement the end-to-end binding stage for `Attachments and timeline show proof of work` in UX-NAV-03.
