...
- This task advances the full-stack product slice: Queue, search, and draft recovery complete the operator loop.
- Stage outcome: Database/persistence foundation. Persisted records can be created/read through the intended storage path or a precise blocker is recorded.
