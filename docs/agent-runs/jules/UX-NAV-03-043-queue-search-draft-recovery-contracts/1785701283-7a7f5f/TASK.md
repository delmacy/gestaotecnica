# UX-NAV-03-043-queue-search-draft-recovery-contracts - Queue, search, and draft recovery complete the operator loop - Contracts and DTOs

        Implement the contracts and dtos stage for `Queue, search, and draft recovery complete the operator loop` in UX-NAV-03.
...
Stage objective: Define the typed request/response/view contract consumed by API and UI, including empty/blocked/demo/real-data states.
