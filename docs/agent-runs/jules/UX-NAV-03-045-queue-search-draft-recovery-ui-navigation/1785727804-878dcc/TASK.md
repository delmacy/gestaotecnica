# UX-NAV-03-045-queue-search-draft-recovery-ui-navigation - Queue, search, and draft recovery complete the operator loop - UI navigation surface

        Implement the ui navigation surface stage for `Queue, search, and draft recovery complete the operator loop` in UX-NAV-03.
...
Stage objective: Make the capability visible and usable in the appropriate screen, menu, route, breadcrumb, detail, or dashboard entry.
