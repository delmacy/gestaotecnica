...
Draft branch: `not published; use WORKER_PARTIAL.patch`
Preserved patch: `docs/agent-runs/jules/UX-NAV-03-047-queue-search-draft-recovery-audit-permissions/1785756724-116667/WORKER_PARTIAL.patch` if present
