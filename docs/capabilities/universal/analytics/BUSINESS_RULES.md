...
## Regras comuns
- Mudanças entre draft, verified, published, deprecated são explícitas, autorizadas e auditáveis.
...
- Relações com audit, enterprise_architecture não permitem alteração indireta sem contrato.
