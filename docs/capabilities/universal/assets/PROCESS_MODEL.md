...
register asset; transfer; maintain; retire
...
## Relações
work_orders, inventory podem fornecer entradas, decisões, recursos ou saídas; a dependência deve permanecer explícita.
