...
## Regras comuns
- Mudanças entre recorded, under_review, accepted, disputed são explícitas, autorizadas e auditáveis.
...
- Relações com governance, all operational capabilities não permitem alteração indireta sem contrato.
