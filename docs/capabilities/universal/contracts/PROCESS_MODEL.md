...
draft contract; review; sign; renew
...
## Relações
customers, providers, approvals, legal podem fornecer entradas, decisões, recursos ou saídas; a dependência deve permanecer explícita.
