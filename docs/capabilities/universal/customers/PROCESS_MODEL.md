# Process Model — customers

## Processos principais
register customer; maintain relationship; manage contacts
...
## Relações
organization, communication podem fornecer entradas, decisões, recursos ou saídas; a dependência deve permanecer explícita.
