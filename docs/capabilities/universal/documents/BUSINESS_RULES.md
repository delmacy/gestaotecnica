...
## Regras comuns
- Mudanças entre draft, review, approved, signed, archived são explícitas, autorizadas e auditáveis.
...
- Relações com audit, approvals não permitem alteração indireta sem contrato.
