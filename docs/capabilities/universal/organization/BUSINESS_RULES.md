...
## Regras comuns
- Mudanças entre draft, active, suspended, archived são explícitas, autorizadas e auditáveis.
...
- Relações com people, governance não permitem alteração indireta sem contrato.
