...
create organization; structure workspace; manage units
...
## Relações
people, governance podem fornecer entradas, decisões, recursos ou saídas; a dependência deve permanecer explícita.
