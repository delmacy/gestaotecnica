# Business Rules — people

## Regras comuns
- Mudanças entre invited, active, unavailable, inactive são explícitas, autorizadas e auditáveis.
...
- Relações com organization, governance, scheduling não permitem alteração indireta sem contrato.
