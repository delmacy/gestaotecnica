# Business Rules — requests

## Regras comuns
- Mudanças entre new, triage, qualified, converted, closed são explícitas, autorizadas e auditáveis.
...
- Relações com customers, communication, cases, work_orders não permitem alteração indireta sem contrato.
