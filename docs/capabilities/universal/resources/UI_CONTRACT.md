# UI Contract — resources

## Superfícies mínimas
Lista/board, detalhe, criação ou comando permitido, filtros, histórico e relações com scheduling, work_orders.

## Estados obrigatórios
Vazio, carregando, erro, acesso negado, sucesso e os estados de domínio: available, reserved, allocated, unavailable.
