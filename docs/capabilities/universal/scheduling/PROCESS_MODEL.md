...
find availability; reserve; reschedule; cancel
...
## Relações
people, resources, work_orders podem fornecer entradas, decisões, recursos ou saídas; a dependência deve permanecer explícita.
