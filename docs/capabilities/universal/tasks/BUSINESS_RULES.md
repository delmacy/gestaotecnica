...
## Regras comuns
- Mudanças entre backlog, ready, in_progress, blocked, review, done são explícitas, autorizadas e auditáveis.
...
- Relações com people, cases, work_orders não permitem alteração indireta sem contrato.
