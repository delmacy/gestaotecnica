...
|---|---|---|---|---|---|---|---|---|
| DEV-READINESS-BUILDER-SHELL-001 | UI_CONTRACT_SHELL | true | false | false | false | READY_FOR_DEV_WITH_LIMITS | Shell pode ser implementado como layout/plataforma visual com dados sintéticos, sem autenticação real, sem RBAC real, sem banco, sem runtime e sem fontes reais. | Iniciar DEV-BUILDER-SHELL-001 |
