...
| DEV-READINESS-RUNTIME-001 | RUNTIME_CONTRACT | false | false | true | true | NOT_READY | Contratos de runtime e eventos definidos, porém execução e dispatch reais permanecem bloqueados até correção dos gaps críticos de transação, tenancy, idempotência, outbox, delivery receipts, concorrência e testes. | INTEGRATION-CONTRACT-001 |
