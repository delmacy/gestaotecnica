...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/admin/gateway/receipts
Call log:
  - navigating to "http://localhost:3000/admin/gateway/receipts", waiting until "load"
