              ...
              <div className="rounded-lg border border-destructive/20 bg-background p-4 space-y-3 text-sm">
                ...
                {diagnostics.canConnect && !diagnostics.isSynthetic && diagnostics.isSuperuser && (
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      <strong>Ação:</strong> Utilize uma credencial com privilégios limitados (ex: <code className="text-xs font-semibold font-mono font-mono">app_runtime</code>) para as operações em runtime, aderindo ao princípio do menor privilégio.
                    </p>
                  </div>
                )}
          ...
          <Card className="w-full">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-medium">
                Caso precise recuperar o acesso, consulte o procedimento administrativo de recuperação seguro documentado em:
              </p>
              <div className="rounded border bg-muted p-2 font-mono text-xs text-muted-foreground">
                docs/auth/PLATFORM_ADMIN_ACCESS.md
              </div>
              <p className="text-xs text-muted-foreground">
                <strong>Aviso de Segurança:</strong> Nunca sugira o uso de privilégios de superusuário para contornar bloqueios em runtime.
              </p>
