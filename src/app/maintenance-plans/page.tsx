...
import { MaintenancePlanForm } from "@/modules/maintenance-plans/maintenance-plan-form";
import { MaintenancePlansList } from "@/modules/maintenance-plans/maintenance-plans-list";
import {
  getMaintenancePlanOptions,
  getMaintenancePlanSummary,
  getMaintenancePlans,
} from "@/modules/maintenance-plans/queries";

export const dynamic = "force-dynamic";

export default async function MaintenancePlansPage() {
  const [plans, summary, options] = await Promise.all([getMaintenancePlans(), getMaintenancePlanSummary(), getMaintenancePlanOptions()]);
  return (
