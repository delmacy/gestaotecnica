...
import { ShiftForm } from "@/modules/shifts/shift-form";
import { ShiftsTable } from "@/modules/shifts/shifts-table";
import { getShifts, getShiftSummary } from "@/modules/shifts/queries";

export const dynamic = "force-dynamic";

export default async function ShiftsPage() {
  const [shifts, summary] = await Promise.all([getShifts(), getShiftSummary()]);
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-[#4d5848]">
                Registro de ocorrencias, pendencias e passagem de servico entre
                equipes.
              </p>
            </div>
            <Link
