...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/evidences", label: "Evidências", description: "Comprovantes, fotos e registros", icon: Camera },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/documents", label: "Documentos", description: "Arquivos e documentação", icon: FileText },
