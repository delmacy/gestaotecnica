...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/queues", label: "Filas/SLA", description: "Gerenciamento de filas e recuperação de rascunhos", icon: ListChecks },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/documents", label: "Documentos", description: "Relatórios, despachos e revisões", icon: FileText },
      { href: "/evidences", label: "Evidências", description: "Comprovantes, fotos e registros", icon: Image },
