...
export function InventoryItemForm({ options, workspaceId }: { options: InventoryOptions; workspaceId: string }) {
  return (
    <form action={createInventoryItem} className="border border-[#d7dccf] bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          <input className="h-11 border border-[#c8d0bf] bg-[#fbfcf8] px-3 text-sm" name="lot" placeholder="Lote" />
        </div>
        <div className="grid gap-3 sm:grid-cols-2">
...
export function InventoryMovementForm({ options, workspaceId }: { options: InventoryOptions; workspaceId: string }) {
  return (
    <form action={createInventoryMovement} className="border border-[#d7dccf] bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 space-y-4">
        ...
        <input className="h-11 w-full border border-[#c8d0bf] bg-[#fbfcf8] px-3 text-sm" name="reason" placeholder="Motivo da movimentacao" />
        <div className="grid gap-3 sm:grid-cols-2">
