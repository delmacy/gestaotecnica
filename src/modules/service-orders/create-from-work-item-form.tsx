...
export function CreateServiceOrderFromWorkItemForm({
  ...
  return (
    ...
    >
      ...
      <div className="mb-5">
        <h2 className="text-lg font-semibold text-[#111510]">Criar execucao</h2>
        <p className="mt-1 text-sm leading-6 text-[#5b6655]">
          Gere uma execucao a partir desta demanda.
        </p>
      </div>

      <label className="mb-4 block">
        <span className="text-sm font-medium text-[#273025]">Tipo de execucao</span>
        <select
      ...
      <label className="block">
        <span className="text-sm font-medium text-[#273025]">Objetivo da execucao</span>
        <textarea
          ...
          name="objective"
          placeholder="Objetivo responsavel da execucao. Se vazio, usa a descricao da demanda."
        />
      </label>
