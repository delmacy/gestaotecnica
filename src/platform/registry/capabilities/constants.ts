...
export type CapabilityDomainLiteral = (typeof CAPABILITY_DOMAINS)[keyof typeof CAPABILITY_DOMAINS];
...
export type CapabilityGroupLiteral = (typeof CAPABILITY_GROUPS)[keyof typeof CAPABILITY_GROUPS];
