...
export async function seedLaunchDemo(dbPlatform: any, dbRuntime: any) {
  ...
  const candidateExists = existingCandidates.find((c: any) => c.name === LAUNCH_DEMO.candidate.name);
