...
const baseline: BaselineEntry[] = [
  ...
  { file: 'src/platform/workflows/infra/workflow.repository.ts', importPath: '@/db', ruleName: 'Runtime boundaries', severity: 'BLOCKER' },
  { file: 'src/platform/workflows/infra/workflow.repository.ts', importPath: '@/db/runtime/schema/workflow', ruleName: 'Runtime boundaries', severity: 'BLOCKER' },
  { file: 'src/platform/workflows/infra/workflow.repository.ts', importPath: '@/db/runtime/schema/workflow', ruleName: 'Deep import from src/db. Use public index instead.', severity: 'MEDIUM' },
